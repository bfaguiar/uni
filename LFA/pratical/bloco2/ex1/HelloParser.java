...
public class HelloParser extends Parser {
	...
	public static final int
		RULE_top = 0, RULE_bye = 1, RULE_greetings = 2, RULE_fullName = 3;
	public static final String[] ruleNames = {
		"top", "bye", "greetings", "fullName"
	};
	...
	public final GreetingsContext greetings() throws RecognitionException {
		...
		try {
			...
			match(T__1);
			setState(27);
			((GreetingsContext)_localctx).fullName = fullName();

			  System.out.println("Ola " + ((GreetingsContext)_localctx).fullName.list);
	...
	public static class FullNameContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof HelloListener ) ((HelloListener)listener).enterFullName(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof HelloListener ) ((HelloListener)listener).exitFullName(this);
		}
	}
	...
	public final FullNameContext fullName() throws RecognitionException {
		...
		enterRule(_localctx, 6, RULE_fullName);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
			...
			do {
				...
				{
				setState(30);
				((FullNameContext)_localctx).ID = match(ID);

				  ((FullNameContext)_localctx).list =  _localctx.list + (_localctx.list.isEmpty() ? "" : ", ") + (((FullNameContext)_localctx).ID!=null?((FullNameContext)_localctx).ID.getText():null); 
				}
				}
				setState(34); 
				_errHandler.sync(this);
	...
	public static final String _serializedATN =
		...
		"\3\6\3\27\n\3\r\3\16\3\30\3\3\3\3\3\4\3\4\3\4\3\4\3\5\3\5\6\5#\n\5\r\5"+
		"\16\5$\3\5\2\2\6\2\4\6\b\2\2\2&\2\f\3\2\2\2\4\22\3\2\2\2\6\34\3\2\2\2"+
		"\b\"\3\2\2\2\n\r\5\6\4\2\13\r\5\4\3\2\f\n\3\2\2\2\f\13\3\2\2\2\r\16\3"+
		"\2\2\2\16\f\3\2\2\2\16\17\3\2\2\2\17\20\3\2\2\2\20\21\7\2\2\3\21\3\3\2"+
		"\2\2\22\23\7\3\2\2\23\26\b\3\1\2\24\25\7\5\2\2\25\27\b\3\1\2\26\24\3\2"+
		"\2\2\27\30\3\2\2\2\30\26\3\2\2\2\30\31\3\2\2\2\31\32\3\2\2\2\32\33\b\3"+
		"\1\2\33\5\3\2\2\2\34\35\7\4\2\2\35\36\5\b\5\2\36\37\b\4\1\2\37\7\3\2\2"+
