...
public interface HelloListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link HelloParser#fullName}.
	 * @param ctx the parse tree
	 */
	void enterFullName(HelloParser.FullNameContext ctx);
	/**
	 * Exit a parse tree produced by {@link HelloParser#fullName}.
	 * @param ctx the parse tree
	 */
	void exitFullName(HelloParser.FullNameContext ctx);
}