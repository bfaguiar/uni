			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						setState(32);
						((ExprContext)_localctx).opx = _input.LT(1);
						_la = _input.LA(1);
						if ( !(_la==T__0 || _la==T__1) ) {
							((ExprContext)_localctx).opx = (Token)_errHandler.recoverInline(this);
						}
						else {
						...
						((ExprContext)_localctx).op2 = ((ExprContext)_localctx).expr = expr(5);
						                      ...
						                      if ((((ExprContext)_localctx).opx!=null?((ExprContext)_localctx).opx.getText():null).equals("*"))
						                        ((ExprContext)_localctx).result =  ((ExprContext)_localctx).op1.result * ((ExprContext)_localctx).op2.result;
						                      else
						                        ((ExprContext)_localctx).result =  ((ExprContext)_localctx).op1.result / ((ExprContext)_localctx).op2.result;
