...
public class Translatenumbers {
	...
	public static void main(String[] args) throws IOException {
	    ...
	    List<String> valid = Arrays.asList(words).parallelStream().filter(n -> (mapa.containsKey(n)))  .collect(Collectors.toList());
	   
	    
	    
	    
	   // validWords.forEach(out::println);
...
//	    	if (Double.parseDouble(validWords.get(i)) >= 100) 
//	    		result = result * Double.parseDouble(validWords.get(i));
//	    	else
//	    		
//	    }
//			  			
