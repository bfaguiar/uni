	...
	public static void main(String[] args) {
		...
		switch(opcao) {
			case 1:
				...
				switch(utilizador) {
					...
					case "aluno":
							...
							c = new cliente(dataInsc, nome, cc, dataNasc, nmec, curso, 0);
							estudante objEstudante = new estudante(nmec, curso, c);
						...
						case "funcionario":
							...
							c = new cliente(dataInscF, nomeF, ccF, dataNascF, 0, null, nFiscal);
							funcionario objFuncionario = new funcionario(nFiscal, c);
			...
			case 4:
				...
				objVid = new video(nomeVid, iddVid, categoria);
				vid.add(objVid);
			...
			case 11:
				System.out.print("Insira o ID do video que possui emprestado que quer avaliar: ");
				int prevIDvideo = sc.nextInt();
				System.out.print("Insira a avaliacao do video que acha a mais correcta (0-10): ");
				double rate = sc.nextInt();
				
				
				emprestimo AuxEE = emp.get(prevIDvideo-1);
				cliente AuxCC = AuxEE.cl();
				video AuxVV =  AuxEE.vi();
				objRt = new rating(AuxCC, AuxVV, rate);
				rt.add(objRt);
				
			case 12:
				System.out.print("Insira o ID do video no qual deseja ver o rating: ");
				int IDvidMedia = sc.nextInt();
				rating k = rt.get(IDvidMedia-1);
				double rr = k.rate();
