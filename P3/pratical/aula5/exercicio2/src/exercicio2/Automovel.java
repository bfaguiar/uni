...
public class Automovel extends Veiculo implements Motorizado {
	...
	public Automovel(String cor, int ano, int velocidadeMaxima, int matricula, int cilindrada, int potencia, int consumo, int combustivel) {
	...
	public String toString() {
		return "Automovel [potencia=" + potencia + ", consumo=" + consumo + ", combustivel=" + combustivel + ", nRodas="
