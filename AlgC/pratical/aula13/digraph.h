...
/*******************************************************************************
 ...
 contrário no parâmetro preg. Valores de retorno: OK, NO_DIGRAPH, DIGRAPH_EMPTY
 ou NULL_PTR.
 
 Verifies if digraph pdig is a regular digraph. Stores 1 in affirmative case and 0
 otherwise in parameter preg. Returning error codes: OK, NO_DIGRAPH, DIGRAPH_EMPTY
 or NULL_PTR. 
*******************************************************************************/
...
/*******************************************************************************
 ...
 Creates the complementary digraph of pdig. Returns the reference to the new 
 digraph or NULL if there isn't enough memory.
