...
/*******************************************************************************
 ...
 Autor : António Manuel Adrego da Rocha    Data : Abril de 2017
...
/*******************************************************************************
 Determina de forma repetitiva a soma dos elementos ímpares da arvore fazendo
 uma trevessia por níveis usando uma fila. Valores de erro: OK, ABP_EMPTY ou NO_MEM.

 Sum all odd elements of the tree pointed by proot, making a level-by-level
...
/*******************************************************************************
 Determina de forma repetitiva quantos elementos da arvore são múltiplos
 de pvalue fazendo uma travessia em profundidade utilizando uma pilha.
 Valores de erro: OK, ABP_EMPTY ou NO_MEM.

 Count all elements of the tree pointed by proot that are multiple of pvalue, making
 an in-depth traversal of the tree using a stack. Error codes: OK, ABP_EMPTY or NO_MEM.
*******************************************************************************/

unsigned int ABPLeavesCount (PtABPNode proot);
/*******************************************************************************
 Determina de forma recursiva o número de folhas da arvore. Valores de erro: OK ou ABP_EMPTY.

 Counts all the leaves of the tree pointed by proot recursively. Error codes: OK or ABP_EMPTY.
*******************************************************************************/

unsigned int ABPEvenCount (PtABPNode proot);
/*******************************************************************************
 Determina de forma recursiva quantos elementos da arvore são ímpares.
 Valores de erro: OK ou ABP_EMPTY.

 Counts all even elements of the tree pointed by proot recursively. Error codes: OK or ABP_EMPTY.
*******************************************************************************/

int ABPOddOrderSum (PtABPNode proot);
/*******************************************************************************
 Determina de forma repetitiva a soma dos elementos da arvore com número de
 ordem ímpar (primeiro + terceiro + quinto + etc.) fazendo uma travessia em profundidade
...
void ABPEvenPrint (PtABPNode proot);
/*******************************************************************************
 Imprime de forma recursiva por ordem crescente os números pares armazenados na
 árvore. Valores de erro: OK or ABP_EMPTY.

 Prints recursively all even elements of the tree pointed by proot by increasing
