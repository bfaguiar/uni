...
int main (void)
{
  ...
  int Option, l, Matrix1, Matrix2, Matrix3, Equals, Sym, Tri;
  ...
  do
  {
    ...
    switch (Option)
    {
        ...
        case 8 :  ReadMatrixIndex (&Matrix1, "primeira matriz");
                  ...
                  {
                    if (Equals) printf("\e[32;1f| \e[1mAs matrizes %d e %d sao iguais", Matrix1, Matrix2);
                    else printf("\e[32;1f| \e[1mAs matrizes %d e %d nao sao iguais", Matrix1, Matrix2);
                    printf("\e[0m\e[33;1f| Prima uma tecla para continuar ");
                    scanf ("%*[^\n]"); scanf ("%*c");
                  }
                  break;
        ...
        case 12 : ReadMatrixIndex (&Matrix1, "matriz");
                  ...
                  printf("\e[1m\e[32;1f| Matriz %d                     ", Matrix1);
                  printf("\e[0m\e[33;1f| Prima uma tecla para continuar ");
                  scanf ("%*[^\n]"); scanf ("%*c");
                  break;
        ...
        case 15 : ReadMatrixIndex (&Matrix1, "matriz");
                  ...
                  {
                    if (Sym) printf("\e[32;1f| \e[1mA matriz %d e simetrica", Matrix1);
                    else printf("\e[32;1f| \e[1mA matriz %d nao e simetrica", Matrix1);
                    printf("\e[0m\e[33;1f| Prima uma tecla para continuar ");
                    scanf ("%*[^\n]"); scanf ("%*c");
                  }
                  break;
        ...
        case 16 : ReadMatrixIndex (&Matrix1, "matriz");
                  if (NotActiveMatrix (MatrixArray, Matrix1)) break;
                  Tri = MatrixIsUpperTriangular (MatrixArray[Matrix1]);
                  if (MatrixError ()) WriteErrorMessage ("A verificacao de triangular superior");
                  else
                  {
                    if (Tri) printf("\e[32;1f| \e[1mA matriz %d e triangular superior", Matrix1);
                    else printf("\e[32;1f| \e[1mA matriz %d nao e triangular superior", Matrix1);
                    printf("\e[0m\e[33;1f| Prima uma tecla para continuar ");
                    scanf ("%*[^\n]"); scanf ("%*c");
                  }
                  break;

        case 17 : ReadMatrixIndex (&Matrix1, "matriz origem");
                  if (NotActiveMatrix (MatrixArray, Matrix1)) break;
...
void Menu (void)
{
  ...
  printf("\e[20;1f| 16 - Verificar triangular      | Matriz 15 =                |                                                            |\n");
  printf("\e[21;1f| 17 - Criar submatriz           | Matriz 16 =                |                                                            |\n");
  printf("\e[22;1f|  0 - Terminar o programa       | Matriz 17 =                |                                                            |\n");
  printf("\e[23;1f|~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~| Matriz 18 =                |                                                            |\n");
  printf("\e[24;1f| Opcao ->                       | Matriz 19 =                |                                                            |\n");
  printf("\e[25;1f~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n");
  printf("\e[26;1f|                                               Janela de Aquisicao de Dados                                               |\n");
  printf("\e[27;1f~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n");
  printf("\e[28;1f|                                                                                                                          |\n");
  printf("\e[29;1f~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n");
  printf("\e[30;1f|                                        Janela de Mensagens de Erro e de Resultados                                       |\n");
  printf("\e[31;1f~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n");
  printf("\e[32;1f|                                                                                                                          |\n");
  printf("\e[33;1f|                                                                                                                          |\n");
  printf("\e[34;1f~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n");
...
void ReadOption (int *poption)
{
  do
  {
    printf("\e[24;1f| Opcao ->                       |");
    printf("\e[24;12f"); scanf ("%d", poption);
    scanf ("%*[^\n]"); scanf ("%*c");
...
void ReadMatrixIndex (int *pnm, char *pmsg)
{
  ...
  {
    *pnm = -1;
    printf("\e[28;1f| Indice da %s ->                               ", pmsg);
    printf("\e[28;%df", 17+MsgLen); scanf ("%d", pnm);
    scanf ("%*[^\n]"); scanf ("%*c");
...
int ActiveMatrix (PtMatrix pmatarray[], int pnmat)
{
  ...
  if (pmatarray[pnmat] != NULL)
  {
    do
    {
      printf("\e[1m\e[32;1f| A matriz %d ja existe!                     ", pnmat);
      printf("\e[0m\e[33;1f| Deseja apaga-la (s/n)? ");
...
int NotActiveMatrix (PtMatrix pmatarray[], int pnmat)
{
  if (pmatarray[pnmat] == NULL)
  {
    printf("\e[1m\e[32;1f| A matriz %d nao existe!                     ", pnmat);
    printf("\e[0m\e[33;1f| Prima uma tecla para continuar ");
    scanf ("%*[^\n]"); scanf ("%*c");
    return 1;
  }
...
void ReadMatrixSize (unsigned int *pnl, unsigned int *pnc)
{
  ...
  {
    *pnl = 0;
    printf("\e[28;1f| Nº de linhas da matriz ->                               ");
    printf("\e[28;29f"); scanf ("%d", pnl);
    scanf ("%*[^\n]"); scanf ("%*c");
  } while (*pnl < 1 || *pnl > 10);
  ...
  {
    *pnc = 0;
    printf("\e[28;1f| Nº de colunas da matriz ->                              ");
    printf("\e[28;30f"); scanf ("%d", pnc);
    scanf ("%*[^\n]"); scanf ("%*c");
  } while (*pnc < 1 || *pnc > 10);
}
...
void ReadFilename (char *pfname)
{
  ...
  do
  {
    printf("\e[28;1f| Nome do ficheiro ->                               ");
    printf("\e[28;23f"); Status = scanf ("%20[^\n]", pfname);
    scanf ("%*[^\n]"); scanf ("%*c");
  } while (Status == 0);
}
...
{
  printf("\e[32;1f| %s de matrizes nao foi efectuada devido a -> \e[1m%s", pmsg, MatrixErrorMessage ());
  printf("\e[0m\e[33;1f| Prima uma tecla para continuar ");
  scanf ("%*[^\n]"); scanf ("%*c");
}
...
{
  printf("\e[1m\e[32;1f| %s \e[1m%f", pmsg, pval);
  printf("\e[0m\e[33;1f| Prima uma tecla para continuar ");
  scanf ("%*[^\n]"); scanf ("%*c");
}
...
PtMatrix ReadMatrix (int pnl, int pnc)
{
  ...
  for (L = 1; L <= pnl; L++)
  {
    for (C = 1; C <= pnc; C++)
    {
      do
      {
        printf("\e[28;1f| Matriz[%d,%d]?                                          ", L, C);
        printf("\e[28;16f"); Status = scanf ("%lf", &Element);
        scanf ("%*[^\n]"); scanf ("%*c");
      } while (Status == 0);
...
void ChangeMatrix (PtMatrix pmat)
{
  ...
  do
  {
    ...
    {
      L = -1;
      printf("\e[28;1f| Nº da linha do elemento da matriz ->                    ");
      printf("\e[28;40f"); scanf ("%d", &L);
      scanf ("%*[^\n]"); scanf ("%*c");
    } while (L < 1 || L > NL);
    ...
    {
      C = -1;
      printf("\e[28;1f| Nº da coluna do elemento da matriz ->                   ");
      printf("\e[28;41f"); scanf ("%d", &C);
      scanf ("%*[^\n]"); scanf ("%*c");
    } while (C < 1 || C > NC);
    ...
    do
    {
      printf("\e[28;1f| Deseja alterar mais algum elemento da matriz (s/n)?     ");
      printf("\e[28;55f"); scanf ("%c", &Character); Character = tolower (Character);
      scanf ("%*[^\n]"); scanf ("%*c");
    } while (Character != 'n' && Character != 's');
  } while (Character == 's');
}
...
double ReadValue (void)
{
  ...
  do
  {
	printf("\e[28;1f| Escalar a multiplicar ->                            ");
	printf("\e[28;28f"); Status = scanf ("%lf", &Value);
    scanf ("%*[^\n]"); scanf ("%*c");
  } while (Status == 0);
...
unsigned int ReadRow (char *pmsg, unsigned int psize)
{
  ...
  do
  {
    printf("\e[28;1f| Nº da linha (%s) da matriz ->                    ", pmsg);
    printf("\e[28;41f"); scanf ("%d", &Row);
    scanf ("%*[^\n]"); scanf ("%*c");
...
unsigned int ReadColumn (char *pmsg, unsigned int psize)
{
  ...
  do
  {
    printf("\e[28;1f| Nº da coluna (%s) da matriz ->                   ", pmsg);
    printf("\e[28;42f"); scanf ("%d", &Col);
    scanf ("%*[^\n]"); scanf ("%*c");
