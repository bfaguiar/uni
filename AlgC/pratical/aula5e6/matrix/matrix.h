...
/*******************************************************************************
 ...
 considering that the line is numbered from 1 to NL and the column is numbered
 from 1 to NC. Error codes: OK, NO_MATRIX, BAD_ROW or BAD_COLUMN.
*******************************************************************************/
...
/*******************************************************************************
 ...
 Matrix multiplication. Returns the reference to the new matrix or NULL if it isn't
 possible to make the operation. Error codes: OK, NO_MATRIX, NO_CHAINED or NO_MEM.
*******************************************************************************/
...
int MatrixIsUpperTriangular (PtMatrix pmatrix);
/*******************************************************************************
 Determina se a matriz pmatrix é uma matriz triangular superior. Devolve 1 em caso 
 afirmativo e 0 no caso contrário. Valores de erro: OK ou NO_MATRIX.

 Verifies if matrix pmatrix is upper triangular. Returns 1 in affirmative case
 and 0 otherwise. Error codes: OK or NO_MATRIX.
*******************************************************************************/
...
/*******************************************************************************
 Cria a submatriz a partir da matriz pmatrix sem a linha pl e a coluna pc, tendo em
 atenção que a linha deve ser indicada de 1 a NL e a coluna devem ser indicada de
 1 a NC. Devolve a referência da matriz produto ou NULL, caso não consiga fazer a
 operação. Valores de erro: OK, NO_MATRIX, BAD_ROW, BAD_COLUMN, BAD_SIZE ou NO_MEM.
