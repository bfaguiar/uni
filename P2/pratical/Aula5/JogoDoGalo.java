...
public class JogoDoGalo {
  ...
  public boolean ultimoJogadorGanhou()
  {
	  ...
	  for(int i = 0; i<3; i++)
	  {
		  if(tabuleiro[i][0]==tabuleiro[i][1] && tabuleiro[i][1]==tabuleiro[i][2] && tabuleiro[i][1]!=VAZIO || tabuleiro[0][i]==tabuleiro[1][i] && tabuleiro[1][i]==tabuleiro[2][i] && tabuleiro[1][i]!=VAZIO)
          return true;
	  }
	  if(tabuleiro[1][1]!=VAZIO && (tabuleiro[0][0]==tabuleiro[1][1] && tabuleiro[1][1]==tabuleiro[2][2] || tabuleiro[0][2]==tabuleiro[1][1] && tabuleiro[1][1]==tabuleiro[2][0])) 
	  return true;
	  return false;
  }
