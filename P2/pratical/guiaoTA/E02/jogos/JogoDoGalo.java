...
public class JogoDoGalo {
  public static final char VAZIO = '\0'; //utilizacao do final: A constante VAZIO nao pode mudar de valor. 
  ...
  public void jogada(int lin, int col) {
    ...
    // os "?" e ":" é uma maneira curta de fazer um "if, then, else".
    // EXEMPLO: int x = y >= 10 ? 5 : 0; TRADUCAO: se o y for >= 10, então o x = 5, senao, x = 0; 
