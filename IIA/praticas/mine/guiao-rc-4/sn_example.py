...
#z.insert(Declaration('bruno', Association('socrates', 'altura', 1.20)))
#z.insert(Declaration('bruno', Association('vertebrado', 'altura', 1.20)))
...
#print(z)
#print(  " ")
#print(z.query_local(user='simao'))
#z.show_query_result()
#print(z.assoc_names())
#print(z.object_list())
#print(z.users_list())
#print(z.types_list())
#print(z.entity_assoclist('socrates'))
#print(z.user_assoclist('descartes'))
#print(z.user_assoccount('descartes'))
#print(z.tuple_decl_info('socrates'))
#print(z.predecessora('vertebrado', 'filosofo'))
#print(z.predecessora('vertebrado', 'socrates'))
#print(z.prodecessora_path('vertebrado', 'socrates'))

#print(z.query_cancel('socrates', 'altura'))
#z.show_query_result()
print(z.query('homem', 'altura'))
#print(z.teste('socrates'))
...
print(z.query_assoc_value('homem', 'altura', 1.75))