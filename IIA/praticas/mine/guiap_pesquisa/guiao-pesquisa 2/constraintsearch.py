...
class ConstraintSearch:
    ...
    def search(self,domains=None):
        ...
        if all([len(lv)==1 for lv in list(domains.values())]): # se valores violam restricoes, falha ( verificacao desnecessaria se for feita a propagacao de restricoes )
            for (var1,var2) in self.constraints:
                constraint = self.constraints[var1,var2] ## dicionario onde estao as funcoes
    ...
    ## ver o que o professor implementou na aula "pesquisacomrestricoespy.py".py  e implementar aquui.
